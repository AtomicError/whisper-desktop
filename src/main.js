...
window.getCurrentSourceMediaFile = function() {
  return selectedMediaFile || (selectedMediaFiles && selectedMediaFiles.length > 0 ? selectedMediaFiles[0] : null) || (window.settingsState?.inputFile || null);
};
